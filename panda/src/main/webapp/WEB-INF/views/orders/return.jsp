		...
		<div class="total">
			...
			<ul class="dot_list">
				<li class="tc_3">‘배송 받은 택배사로 직접 신청후 착불 발송’ 선택시 반드시 배송 받은 택배사에
					연락하여 착불 반송 신청을 직접 하셔야 합니다.</li>
				<li class="tc_3">상품불량으로 인한 반품이 아닌 경우, 초기 배송비가 포함됩니다.</li>
				<li class="tc_3 hide">상품불량으로 인한 반품이 아닌 경우, 초기 배송비를 포함한 금액을 동봉해
					주셔야 합니다.</li>
				<li class="tc_8">반품 배송비가 발생 하는 경우 반품 택배 내 배송비를 동봉 해야 하며, 미 동봉 시
					배송비 입금 확인 후 반품 처리가 시작 됩니다.</li>
				<li class="tc_8">최초 배송비가 무료인 경우에도 교환 혹은 환불 진행 시 추가 배송비가 발생 될 수
					있습니다.</li>
			</ul>
		</div>
		<div class="btndiv">
