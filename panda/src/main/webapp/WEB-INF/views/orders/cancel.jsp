...
<body>
		...
		<div id="sidebar">
			<div class="snbArea">
				<ul id="snb">
					...
					<li><a id="a" href="#none" class="order"> 주문 관리 </a>
						<ul class="hide">
	...
	<div class="total">
		...
		<table class="table1">
			<tr>
				<td><span class="gBreak"><input type="checkbox"
						date-interval="30">1개월<input type="checkbox"
						date-interval="90">3개월<input type="text" id="startDate"
						name="start_dt" class="fText gDate" value=""> ~ <input
						type="text" id="endDate" name="end_dt" class="fText gDate"
						readonly="readOnly"> <input type="submit" value="조회">
				</span></td>
			</tr>
		</table>
		<div id="middle">
			<span style="font-size: 15px">${orderview.order_dt}</span> <span
				style="color: #bbb"> | </span> <span style="font-size: 15px">주문번호
				2019082664883377</span> <span style="color: #bbb"> | </span> <span
				style="font-size: 15px">주문 상품 1개</span>
		</div>
		<form action="">
			<table class="table2">
				<thead>
