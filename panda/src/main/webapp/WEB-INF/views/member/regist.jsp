        ...
        $(function () {
            $(".id").on("blur", function () {
                ...
                if (result) {
                    ...
                    span.innerHTML =
                        "<font color = '#de2195' size = '2'>8~15자의 영문 소문자,대문자, 숫자로 입력해주세요</font>"
                ...
                <div>
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <td class="a">아이디</td>
                                <td class="b"><input class="id iText" type="text" name="id" placeholder="아이디 8~16글자" required>
                                        <button id="idCheck">중복확인</button><br><span class="sid"></span></td>
                                        
                            </tr>

                            <tr>
                                <td class="a">비밀번호</td>
                                <td class="b"><input class="pw iText" type="password" name="pw" id="user_pass"
                                        placeholder="8~15자의 영문 대소문자, 숫자, 특수문자(!@#$-_)" required><br> <span
                                        class="spw"></span></td>
                            </tr>
                            <tr>
                                <td class="a">비밀번호 확인</td>
                                <td class="b"><input class="iText" type="password" id="chpass" name="pw_check" placeholder="비밀번호 확인"
                                        required><br>
                            ...
                            <tr>
                                <td class="a">이름</td>
                                <td class="b"><input class="iText" type="text" name="name" placeholder="이름" required></td>
                            </tr>


                            <tr>
                                <td class="a">핸드폰번호</td>
                                <td class="b"><input type="text" name="phone" placeholder="전화번호(- 제외)" class="iText"></td>
                            </tr>
                            ...
                            <tr>
                                <td class="a">이메일</td>
                                <td class="b"><input type="text" name="email" required class="iText"> <button class="email"
                                        >인증하기</button><br> <input id="indentity" type="text" name="identity" required
