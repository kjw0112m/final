	...
	<div id="content">
		<div class="optionArea">
									...
									<div>
										<select class="fSelect" name="type" style="width: 163px;">
											...
											<option value="title+content"
												${type == 'title+content'?'selected':''}>제목+내용</option>
							...
							<td colspan="3">
								<div id="mainSearch">
									<div>
										...
										<a
											href="${pageContext.request.contextPath}/seller/one/oneList?type=state&keyword=Y&page="
											class="btnDate" date-interval="1"><span>YES</span></a> <a
											href="${pageContext.request.contextPath}/seller/one/oneList?type=state&keyword=N&page="
											class="btnDate" date-interval="1"><span>NO</span></a> <a
											href="${pageContext.request.contextPath}/seller/one/oneList"
											class="btnDate" date-interval="1"><span>ALL</span></a>
									</div>
								</div>
					</tbody>
			...
			<div class="form_button">
				<input type="submit" id="btnSearch777" class="btnSearch777"
					value="검색"> <a
					href="${pageContext.request.contextPath}/seller/one/oneList"
					id="btnSearch" class="btnSearch"> 초기화</a>
						...
						<c:otherwise>
							...
							기타문의
										...
										<td class="text-left">
											...
											<a
											href="${pageContext.request.contextPath}/seller/one/oneEdit?mode=EDIT&id=${bdto.id}">
												${bdto.title} </a>
										</td>
										<td>${bdto.memberid}</td>
