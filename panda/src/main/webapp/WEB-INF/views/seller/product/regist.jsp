	...
	<div id="content">
		...
		<div class="regist_form">
			<form action="regist" method="post" enctype="multipart/form-data" name="form">
				...
				<br> <input type="text" name="name" placeholder="상품명"
					class="name_price" required> <br>
				<br> <input type="number" name="price" placeholder="가격"
					class="name_price" required> <br>
				<br> 사이즈 <br>
				<br> <input type="checkbox" name="sizes" value="S"><span class="select_size"> S <input
					type="number" value="0" class="size"></span> <br>
				<br> <input type="checkbox" name="sizes" value="M"><span class="select_size" > M <input
					type="number" value="0" class="size"></span> <br>
				...
				<br> 상세이미지(.gif, .jpeg, .jpg, .png만 등록 가능합니다) <input
					type="file" name="details" accept=".gif, .jpeg, .jpg, .png">
				<br>
