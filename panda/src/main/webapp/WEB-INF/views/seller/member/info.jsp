...
<body>
    <div class="total">
        ...
        <table class="table">
            <tr>
                <td class="a">아이디</td>
                <td class="b"><input type="text" name="id" value="${mdto.id}" readonly></td>
            </tr>
            ...
            <tr>
                ...
                <td class="b">
                    <div>
                        ...
                        <input class="addr" type="button" value="주소 찾기" id="btn1"><br>
                        <input type="text" name="basic_addr" value="${mdto.basic_addr}" class="iText">
                        <input type="text" name="detail_addr" value="${mdto.detail_addr}" class="iText">
                    </div>
                </td>
            </tr>
            <tr>
